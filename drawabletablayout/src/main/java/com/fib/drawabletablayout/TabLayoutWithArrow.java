...
public class TabLayoutWithArrow extends HorizontalScrollView {
    ...
    //Fahad Drawable Fields
    private int mDrawableHeight = 90;
    private Drawable mDrawableIndicator = getResources().getDrawable(R.drawable.semi);

    int mDrawableLeft = 0, mDrawableUp = 0, mDrawableRight = 0, mDrawableDown = 0;
    ...
    public static final class Tab {
        ...
        public Tab setIcon(@DrawableRes int resId) {
            return setIcon(new AppCompatDrawableManager().getDrawable(mParent.getContext(), resId));
        }
...
//                }
            ...
            try {
                if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                    ...
                    mScreenHeight = Math.round(getHeight());
                    mScreenWidth = Math.round(getWidth());

                    mDrawableIndicator.setBounds(mIndicatorLeft + mDrawableLeft,
                            mScreenHeight - mDrawableHeight,
                            mIndicatorRight - mDrawableRight,
                            mScreenHeight);
    ...
    public int getmIndicatorLeft() {
        return mDrawableLeft;
    }

    public int getmIndicatorRight() {
        return mDrawableRight;
    }

    public void setmIndicatorLeftMargin(int left) {
        mDrawableLeft = left;
    }

    public void setmIndicatorRightMargin(int right) {
